...
fn main() {
    ...
    let mut x: Complex = Complex::new(1, 1);
    let y: Complex = Complex::new(2, 3);
    x += y;
    assert_eq!(x, Complex::new(3, 4));
    x += 1;
    assert_eq!(x, Complex::new(4, 4));
    x -= 1;
    assert_eq!(x, Complex::new(3, 4));
    x -= y;
    assert_eq!(x, Complex::new(1, 1));
    let z: Complex = Complex::new(2.5, 0.5);
    x *= z;
    assert_eq!(x, y);
    x *= 2;
    assert_eq!(x, Complex::new(4, 6));
    println!("ok! si pentru bonus")
}
